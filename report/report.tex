...
\author{
  Author\_A \and Author\_B \and Author\_C \and Author\_D
}
\date{\today}
...
Experimental results demonstrate an overall test accuracy of approximately
96.6\% across five gesture classes, with the optimized model running in
