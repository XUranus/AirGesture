...
Training terminated after 92~epochs via early stopping, with the best
test accuracy of 96.55\% achieved at epoch~52.
...
\begin{figure}[ht]
  ...
  \caption{Training curves: loss (left) and accuracy (right) over
    92~epochs. Early stopping was triggered at epoch~92 with the best
